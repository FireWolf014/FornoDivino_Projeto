        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home </a><a href="about.php">Menu </a><a href="contact.php">Contate-nos </a><a href="login.php">Login </a></span></p>
            </div>
    ...
    <section class="ftco-section">
      <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Nossos melhores ex-chefes de cozinha</h2>
            <p class="flip"><span class="deg1"></span><span class="deg2"></span><span class="deg3"></span></p>
            <p class="mt-5">Apenas os melhores já passaram por aqui no Forno Divino</p>
          </div>
        </div>
        <div class="row">
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Antônio da Silva</a></h3>
      					<span class="position">Rio de Janeiro, RJ</span>
      					<div class="text">
	        				<p>Carismático chef carioca, fundador de um restaurante à beira-mar que combina influências brasileiras e internacionais.</p>
	        			</div>
      				</div>
        		</div>
        	</div>
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Gabriel Oliveira</a></h3>
      					<span class="position">Salvador, BA</span>
      					<div class="text">
	        				<p>Apaixonado por gastronomia nordestina, Gabriel comanda um restaurante acolhedor no Pelourinho, onde reinventa pratos tradicionais com um toque pessoal</p>
	        			</div>
      				</div>
        		</div>
        	</div>
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Luiz Carlos Souza</a></h3>
      					<span class="position">Belo Horizonte, MG</span>
      					<div class="text">
	        				<p>Conhecido como "Luizão", este mineiro é mestre em transformar ingredientes simples em deliciosos pratos gourmet em seu restaurante no coração de BH.</p>
	        			</div>
      				</div>
        		</div>
        	</div>
        	<div class="col-lg-3 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					<h3><a href="teacher-single.html">Fernando Costa</a></h3>
      					<span class="position">Florianópolis, SC</span>
      					<div class="text">
	        				<p>Fernando celebra a diversidade culinária de Santa Catarina em seu restaurante à beira da praia, onde os sabores do mar e da terra se encontram em pratos frescos e saborosos.</p>
	        			</div>
      				</div>
        		</div>
        	</div>
