	...
	<section class="ftco-section">
		...
		<div class="container-wrap">
			<div class="row no-gutters d-flex">
				...
				<div class="col-lg-4 d-flex ftco-animate">
					<div class="services-wrap d-flex">
						<a href="#" class="img Adicionar-lg-last" style="background-image: url(images/pizza-4.jpg);"></a>
						<div class="text p-4">
				...
				<div class="col-lg-4 d-flex ftco-animate">
					<div class="services-wrap d-flex">
						<a href="#" class="img Adicionar-lg-last" style="background-image: url(images/pizza-5.jpg);"></a>
						<div class="text p-4">
				...
				<div class="col-lg-4 d-flex ftco-animate">
					<div class="services-wrap d-flex">
						<a href="#" class="img Adicionar-lg-last" style="background-image: url(images/pizza-6.jpg);"></a>
						<div class="text p-4">
							<h3>Marguerita</h3>
							<p>Muito, muito longe, atrás da palavra montanhas, longe dos países Vokalia e Consonantia</p>
							<p class="price"><span>$2.90</span> <a href="#" class="ml-2 btn btn-white btn-outline-white">Adicionar</a></p>
		...
		<div class="container">
			<div class="row justify-content-center mb-5 pb-3 mt-5 pt-5">
				<div class="col-md-7 heading-section text-center ftco-animate">
					<h2 class="mb-4">Nosso cardápio Pricing</h2>
